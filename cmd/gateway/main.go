...
import (
	...
	"github.com/darksol/Vanta/internal/admin"
	"github.com/darksol/Vanta/internal/approval"
	"github.com/darksol/Vanta/internal/builder"
	"github.com/darksol/Vanta/internal/config"
	idb "github.com/darksol/Vanta/internal/db"
	"github.com/darksol/Vanta/internal/eval"
	"github.com/darksol/Vanta/internal/judge"
	"github.com/darksol/Vanta/internal/llm"
...
func newLLMAdapter(cfg config.LLMJudgeConfig, model string, timeout time.Duration, opts ...llm.ResilienceOption) (llm.Adapter, error) {
	...
	case "openai":
		...
		return a, nil
	case "bankr":
		return llm.NewBankrAdapter(model, cfg.BankrAPIKey, cfg.BankrURL, timeout, opts...)
	default:
